...
const callbacksMap = new Map([
    ...
    ['/tag/vue/',
        [
            () => mountComp({
                selector: '.theme-container',
                src: '//music.163.com/outchain/player?type=2&id=1857630559&auto=0&height=66',
                comp: 'wangyiyun2',
            }),
        ]
    ],
    ...
    ['/categories/%E6%94%B6%E8%97%8F%E5%A4%B9/',
        [
            () => mountComp({
                selector: '.theme-container',
                src: '//music.163.com/outchain/player?type=2&id=1407551413&auto=0&height=66',
                comp: 'wangyiyun2',
            }),
        ]
    ],
    ['/categories/%E8%AF%BB%E4%B9%A6%E7%AC%94%E8%AE%B0/',
        [
            () => mountComp({
                selector: '.theme-container',
                src: '//music.163.com/outchain/player?type=2&id=109734&auto=0&height=66',
                comp: 'wangyiyun2',
            }),
        ]
    ],
    ['/categories/%E7%AE%97%E6%B3%95/',
        [
            () => mountComp({
                selector: '.theme-container',
                src: '//music.163.com/outchain/player?type=2&id=551277612&auto=1&height=66',
                comp: 'wangyiyun2',
            }),
        ]
    ],
...
// 某些原生页面组件挂载组件。所有音乐组件最外层加 #musicFlag 做唯一标识
function mountComp({ selector, src, comp }, options = {}) {
    const container = document.querySelector(selector);
    const musicEle = document.querySelector("#musicFlag");
    // 防止无效挂载和重复挂载
    if (!container || musicEle) {
        return;
    }
